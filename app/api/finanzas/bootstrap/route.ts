...
import { loadAccounts, loadCategories, loadPeople, loadRecurring, loadShared, loadTransactions } from '@/lib/finanzas/load'
...
export async function GET(request: Request) {
  ...
  const [accounts, categories, people, shared, recurring, month, recent] = await Promise.all([
